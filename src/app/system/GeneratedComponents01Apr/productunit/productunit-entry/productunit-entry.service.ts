...
export class ProductUnitEntryService {
    ...
    constructor(private _globals: AppGlobals,
        ...
        productUnitControllers(model: Send) {
            return this.http.post(this._globals.baseAPIUrl + 'ProductUnit/getuniventry', model, this._cf.requestOptions()).pipe(
           map((response: any) => {
