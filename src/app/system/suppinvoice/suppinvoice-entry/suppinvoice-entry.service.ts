...
export class SuppInvoiceEntryService {
    ...
    constructor(private _globals: AppGlobals,
        ...
        EntryA(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'SuppInvoice/createuniv',arr).pipe(
            map((response: any) => {
        ...
        EntryE(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'SuppInvoice/edituniv',arr).pipe(
            map((response: any) => {
                console.log('here: ', response.json());
            return response.json();
            }), catchError(this._cf.handleError));
