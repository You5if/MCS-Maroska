...
import { StockPIEntryService } from './stockpi-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-stockpi-entry',
  templateUrl: './stockpi-entry.component.html',
  styleUrls: ['./stockpi-entry.component.scss']
})

export class StockPIEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: StockPIEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<StockPIEntryComponent>,
  ...
  ngOnInit() {
      ...
      this.dapiService.Controllers(this.pModel.entryData).subscribe(res => {
        this._ui.loadingStateChanged.next(false);
        this.data = res;

        console.log( this.pModel.suppInvId);
        
        this.data[1].value = this.pModel.suppInvId.toString()
