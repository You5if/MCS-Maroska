...
export class StockMovementEntryService {
    ...
    constructor(private _globals: AppGlobals,
        ...
        EntryA(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'StockMovement/createuniv',arr).pipe(
            map((response: any) => {
                console.log('here: ', response.json());
            return response.json();
            }), catchError(this._cf.handleError));
        ...
        EntryE(arr: any){
           return this.http.post(this._globals.baseAPIUrl + 'StockMovement/edituniv',arr).pipe(
            map((response: any) => {
                console.log('here: ', response.json());
            return response.json();
            }), catchError(this._cf.handleError));
