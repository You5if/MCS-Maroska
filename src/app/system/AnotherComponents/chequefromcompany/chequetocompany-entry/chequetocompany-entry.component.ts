...
export class ChequeFromCompanyEntryComponent implements OnInit {
  url!: string;
  dialog_title!: string;
  ...
  constructor(
      ...
      private dialogRef: MatDialogRef<ChequeFromCompanyEntryComponent>,
  ...
  onSubmit  (form: ChequeToCompanyModel) {
      form.chequeFromCompanyId = this.pModel.chequeFromCompanyId;
      form = this.pModel;
