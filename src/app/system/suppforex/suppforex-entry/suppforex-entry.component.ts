...
import { SuppForexEntryService } from './suppforex-entry.service';
import { Direction } from '@angular/cdk/bidi';

@Component({
  selector: 'app-suppforex-entry',
  templateUrl: './suppforex-entry.component.html',
  styleUrls: ['./suppforex-entry.component.scss']
})

export class SuppForexEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SuppForexEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SuppForexEntryComponent>,
